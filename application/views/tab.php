...
<div class="container">
	<!---->
		<ul class="nav nav-tabs"  id="tabs">
			...
			<li><a href="<?php echo base_url();?>index.php/main/getSoup">Sopes</a></li>
			<li><a href="<?php echo base_url();?>index.php/main/getRice">Arrosos</a></li>
			<li><a href="<?php echo base_url();?>index.php/main/getPasta">Pasta</a></li>
			<li><a href="<?php echo base_url();?>index.php/main/getMeat">Carns</a></li>
			<li><a href="<?php echo base_url();?>index.php/main/getSeafood">Peixos</a></li>
